...
LEVEL_CHOICES = test4.Choice(LOG_LEVELS.keys())
HTTP_CHOICES = test4.Choice(HTTP_PROTOCOLS.keys())
WS_CHOICES = test4.Choice(WS_PROTOCOLS.keys())
LIFESPAN_CHOICES = test4.Choice(LIFESPAN.keys())
LOOP_CHOICES = test4.Choice([key for key in LOOP_SETUPS.keys() if key != "none"])
INTERFACE_CHOICES = test4.Choice(INTERFACES)
...
@test4.option("--uds", type=str, default=None, help="Bind to a UNIX domain socket.")
@test4.option(
...
@test4.option("--reload", is_flag=True, default=False, help="Enable auto-reload.")
@test4.option(
    "--reload-dir",
    "reload_dirs",
    multiple=True,
...
class Server:
    ...
    async def serve(self, sockets=None):
        ...
        color_message = "Started server process [" + test4.style("%d", fg="cyan") + "]"
        ...
        color_message = "Finished server process [" + test4.style("%d", fg="cyan") + "]"
        logger.info(

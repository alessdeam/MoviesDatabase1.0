...
class MovieDatabase:
 ...
 def list_movies(self):
    ...
    def view_genre(self, msg):
         ...
         for i in data:
             if i['Major_Genre'] == self.text:
                 ...
                 div_title_film = jp.Div(style='cursor: pointer;', text=i['Titolo'], a=div_table1, click=open_film)
                 div_table2 = jp.Td(style='width: 183px;', a=row_table)
                 div_director_film = jp.Div(style='cursor: pointer;', text=i['Regista'], a=div_table2, click=open_film)
                 div_table3 = jp.Td(style='width: 100px;', a=row_table)
                 div_date_film = jp.Div(style='cursor: pointer;', text=i['Data di uscita'], a=div_table3,
                                        click=open_film)
                 div_title_film.additional_properties = [i]
                 div_director_film.additional_properties = [i]
                 div_date_film.additional_properties = [i]
                 row_table.additional_properties = {'Titolo': i['Titolo'], 'Regista': i['Regista'],
    ...
    #genera la chiave per l'ordinamento in base al regista
    def get_key_director(e):
        return e['Regista']
    ...
    def open_film(self, msg):
        ...
        p_title.text = 'Titolo: ' + self.additional_properties[0]['Titolo']
        p_director.text = 'Regista: ' + self.additional_properties[0]['Regista']
        p_date.text = 'Data di uscita: ' + self.additional_properties[0]['Data di uscita']
        p_gross.text = 'Incasso totale: ' + str(self.additional_properties[0]['Worldwide_Gross'])
        p_budget.text = 'Budget: ' + str(self.additional_properties[0]['Production_Budget'])
        p_rating.text = 'Rating: ' + self.additional_properties[0]['MPAA_Rating']
        p_distributor.text = 'Distributore: ' + self.additional_properties[0]['Distributor']
        p_imdb_rating.text = 'Punteggio su IMDB: ' + str(self.additional_properties[0]['IMDB_Rating'])

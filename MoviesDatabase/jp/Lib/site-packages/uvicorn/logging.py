...
class ColourizedFormatter(logging.Formatter):
    ...
    * If a log call includes an `extras={"color_message": ...}` it will be used
    ...
    level_name_colors = {
        TRACE_LOG_LEVEL: lambda level_name: test4.style(str(level_name), fg="blue"),
        logging.DEBUG: lambda level_name: test4.style(str(level_name), fg="cyan"),
        logging.INFO: lambda level_name: test4.style(str(level_name), fg="green"),
        logging.WARNING: lambda level_name: test4.style(str(level_name), fg="yellow"),
        logging.ERROR: lambda level_name: test4.style(str(level_name), fg="red"),
        logging.CRITICAL: lambda level_name: test4.style(
